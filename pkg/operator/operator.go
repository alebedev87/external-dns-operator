...
// +kubebuilder:rbac:groups=externaldns.olm.openshift.io,resources=externaldns,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=externaldns.olm.openshift.io,resources=externaldns/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=externaldns.olm.openshift.io,resources=externaldns/finalizers,verbs=update
