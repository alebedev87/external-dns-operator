...
type ExternalDNSAWSProviderOptions struct {
	...
	// TODO: Additionally support access via the
...
type ExternalDNSGCPProviderOptions struct {
	...
	// contain an object named `service_account.json`
...
type ExternalDNSAzureProviderOptions struct {
	...
	// an object named `azure.json` similar to the following:
	//
	// {
	//   "tenantId": "123",
	//   "subscriptionId": "456",
	...
	// for more infromation on the necessary configuration key/values and how to obtain them.
	//
	// +kubebuilder:validation:Required
	// +required
